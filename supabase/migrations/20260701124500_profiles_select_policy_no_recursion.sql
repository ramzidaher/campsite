-- Remove recursive dependency path in profiles SELECT policy.
-- This policy intentionally avoids helper functions that query public.profiles.
    ...
    or (
      ...
      and (
        ...
        or exists (
          ...
          where viewer_ud.user_id = auth.uid()
