-- Revert structural auxiliary read-model experiment due timeout regression.
...
drop function if exists public.backfill_user_shell_structural_aux(integer);
drop function if exists public.process_shell_structural_aux_recalc_queue(integer);
drop function if exists public.refresh_user_shell_structural_aux(uuid);
drop function if exists public.enqueue_shell_structural_aux_recalc_for_user(uuid, text);
drop table if exists public.shell_structural_aux_recalc_queue;
drop table if exists public.user_shell_structural_aux;
