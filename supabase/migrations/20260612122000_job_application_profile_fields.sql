-- Add common candidate profile fields to job applications and persist them
-- through submit_job_application for better screening context.
...
drop function if exists public.submit_job_application(text, text, text, text, text, text, text, smallint, boolean);
