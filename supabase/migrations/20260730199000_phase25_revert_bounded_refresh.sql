-- Revert 20260730198000 bounded-refresh experiment due regression.
-- Restore known-better shell badge/scheduling function behavior from 20260730197000.

-- Revert 20260730196000 regression: restore synchronous refresh on missing rows.
-- The async-miss strategy increased timeout/non-200 rates under burst traffic.
...
drop function if exists public._refresh_user_badge_counters_bounded(uuid, integer);
