-- Revert 20260730202000 tail-latency tuning regression.
-- Restore:
-- - main_shell_layout_structural permission timeout to 1200ms fail-soft
-- - badge/scheduling stale threshold to 60s (with async-only reads)
