...
const HR_DIRECTORY_RESPONSE_CACHE_TTL_MS = Number.parseInt(
  process.env.CAMPSITE_HR_DIRECTORY_RESPONSE_CACHE_TTL_MS ?? '60000',
  10
);
...
registerSharedCacheStore('campsite:hr:directory', hrDirectoryResponseCache, hrDirectoryInFlight);
...
export const getCachedHrDirectoryPageData = cache(
  async (
    ...
    return getOrLoadSharedCachedValue({
      ...
      key: cacheKey,
      cacheNamespace: 'campsite:hr:directory',
